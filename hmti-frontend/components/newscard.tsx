                ...
                <SwiperSlide key={card.image}>
                    <article className='m-2 rounded-lg shadow-md transition-transform duration-500 hover:scale-100 hover:shadow-lg scale-95 cursor-pointer'>
                        ...
                        <div className='flex flex-col mt-2 px-4'>
                            ...
                            <div className='flex mt-3 items-center'>
                                <Link href='#' className='rounded-lg px-1 pb-0.5 border-0 mb-4 text-base-100 font-semibold btn-primary transition ease-in-out hover:scale-105 duration-300 inline-flex items-center'>
                                    Read More
