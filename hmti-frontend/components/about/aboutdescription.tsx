            ...
            <div className="basis-3/5">
                <Reveal>
                    <div className="text-justify lg:text-xl sm:text-lg text-sm tracking-wide font-semibold opacity-40 hover:opacity-80 cursor-pointer">
                        ...
                        were inaugurated in <b className="font-bold">Room 101 of Building B at the Jenderal Soedirman University's Faculty of Engineering</b>. The Deputy Dekan 3, Head of the Industrial Engineering Department,
